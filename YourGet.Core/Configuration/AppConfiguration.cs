...
namespace YourGet.Core.Configuration
{
    public class AppConfiguration : IAppConfiguration
    {
        ...
        /// </summary>
        public bool AzureStorageReadAccessGeoRedundant
        { get; set; }

        /// <summary>
        /// Gets the URI to the search service
        /// </summary>
        public Uri ServiceDiscoveryUri
        { get; set; }

        /// <summary>
        /// Gets the @type for the Search endpoint
        /// </summary>
        public string SearchServiceResourceType
        { get; set; }

        /// <summary>
        /// Gets the @type for the Autocomplete endpoint
        /// </summary>
        public string AutocompleteServiceResourceType
        { get; set; }

        /// <summary>
        /// Gets the URI to the metrics service
        /// </summary>
        public Uri MetricsServiceUri
        { get; set; }
        ...
        public LuceneIndexLocation LuceneIndexLocation
        { get; set; }*/
        ...
        public MailAddress GalleryOwner
        { get; set; }
        ...
        /// </summary>
        [DefaultValue(true)]
        public bool AutoUpdateSearchIndex
        { get; set; }
    }
}
